...
class kitti_object(object):
    ...
    def __init__(self, root_dir, split="training", args=None):
        ...
        ####change
        self.label_dir = '/media/wuminghu/work/model/SMOKE/train/inference/kitti_train/data'
...
def dataset_viz(root_dir, args):
    ...
    out_path='/media/wuminghu/work/output/SMOKE/img'
    ...
    for data_idx in range(len(dataset)):
        ...
        if args.show_image_with_boxes:
            ...
            # import pdb; pdb.set_trace()
            vis_img=show_image_with_boxes(img, objects, calib, True, None)
